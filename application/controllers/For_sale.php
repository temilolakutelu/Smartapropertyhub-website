...
class For_sale extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        parent::__construct();
        $this->load->model(['Forsale_model', 'Filter_model', 'Login_model']);
    ...
    {
        $total_counts = $this->Forsale_model->record_count();

        $result = $this->Forsale_model->fetch_data($this->perpage, $this->page(), $this->forsale);
    ...
    public function get_subtype()
    {
        ...
        $get_sub = $this->Forsale_model->get_subtype($type_id);
        $subtype = "";
    ...
    public function only_one_is_active($state, $subtype, $bedroom, $price)
    {
        ...
        // $only_one=$this->Forsale_model->active_one($state,$subtype,$bedroom,$price);
    ...
    public function others($result, $count)
    {
        ...
        //$count=$this->Forsale_model->record_count();
        $forsale_state = $this->Forsale_model->get_forsale_state();
        $type = $this->Forsale_model->get_type();
        $states = $this->Forsale_model->get_state();
        // $recent=$this->Forsale_model->get_recent();
