...
class Short_let extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model(['Shortlet_model', 'Filter_model', 'Login_model']);
    ...
    {
        $total_counts = $this->Shortlet_model->record_count();
       
        

        $result = $this->Shortlet_model->fetch_data($this->perpage, $this->page(),$this->forsale);
    ...
    public function get_subtype()
    {
        ...
        $get_sub=$this->Shortlet_model->get_subtype($type_id);
        $subtype="";
    ...
    public function only_one_is_active($state,$subtype,$bedroom,$price){
       ...
       // $only_one=$this->Shortlet_model->active_one($state,$subtype,$bedroom,$price);
    ...
    public function others($result,$count){
        ...
        //$count=$this->Shortlet_model->record_count();
        $shortlet_state=$this->Shortlet_model->get_shortlet_state();
        $type=$this->Shortlet_model->get_type();
        $states=$this->Shortlet_model->get_state();
        // $recent=$this->Shortlet_model->get_recent();
