        ...
        <div class="row">
            <div class="col-md-12">
                <div class="breadcrumb-wrapper">
                    <h2 class="page-title">Short Let</h2>
                    <a href="./home">Home</a>
                    <span>/</span>
                    <span><a href="./short_let">Short Let</a></span>
                </div>
            </div>
        </div>
    </div>
...
<section class="royal-listing-sidebar-area ">
            ...
            <div class="col-md-8 col-sm-12 col-xs-12 page-content">
                <div>
                    <div class="well well-sm">
                        <strong>Properties & Houses for Short Let.</strong>
                        <div class="btn-group">
    ...
    foreach ($results as $shortlet) {?>

                                                        <div class="item list-group-item  col-xs-12 col-sm-6 col-md-4">
                                                            <div class="thumbnail">
                                                                <?php
if ($shortlet->featured == 1) {?>
                                                            <div class="ribbon red"><span>Featured</span></div>
                                                                                        <?php
}?>
                                                        <img class="group list-group-image" src="http://smartpro.propertyhub.com.ng/uploads/<?=$shortlet->imageURL;?>" alt="" />
                                                                                                        ...
                                                                                                        <div class="caption">
                                                                                                            <div class="property-text">
                                                                                                                <h4><a href="<?=site_url('home/property_view/' . $shortlet->property_ID);?>">
                                                                                                                <?=$shortlet->property_Name;?></a></h4>
                                                                                                                <?=$let->street;?>
                                                                                                                <?=$let->city;?>,
                                                                                                                <?=$let->state;?>
                                                                                                                ...
                                                                                                                <div class="pro-details-price">
                                                                                                                    <p>
                                                                                                                        <?php if ($shortlet->currency == 'NGN') {
        echo '₦';
    } elseif ($shortlet->currency == 'USD') {
        echo '$';
    } elseif ($shortlet->currency == 'EUR') {
        echo '€';
    } else {
        echo $shortlet->currency;
    }
        ?>
                                                                                                                <?=number_format($shortlet->price);?>
                                                                                                                </p>
                                                                                                                <a href="<?=site_url('home/property_view/' . $shortlet->property_ID);?>">More Details</a>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
    ...
    <div class="side-fliter" style='margin-top:10px'>
                    ...
                    <div class="single-listing-widget">
                        <h3>Property Adavnced Search</h3>
                        <form action='<?=base_url();?>short_let/filter' method="post">
                ...
                <div id="side" class="mrg-btm-70 ">
                    <a href="http://c.jumia.io/?a=134508&c=451&p=r&E=kkYNyk2M4sk%3d&utm_source=cake&utm_medium=affiliation&utm_campaign=134508&utm_term="><img src="https://affiliates.jumia.com/banners/Jumia Nigeria/WomensShoes/250X250.jpg" /></a>
                </div>

                    <!-- <div class="single-listing-widget">
                        <h3>Recent Short Lets</h3>
                        <ul>
                            <?php
    ...
    $(document).ready(function() {
        ...
        $('#type').on('change', function() {
            ...
            if (type_id == '') {
                ...
                $.ajax({
                    url: "<?=base_url('short_let/get_subtype');?>",
                    type: "POST",
                    data: {
                        'type_id': type_id
                    },
