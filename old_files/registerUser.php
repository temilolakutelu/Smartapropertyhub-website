...
$message="Attention : Smart PropertyHub Limited".
"\n\nPlease be informed that a new User has succesfully registered on PropertyHub Website.".
...
"\n\nThank you.";
//echo $message;
mail ("info@propertyhub.com.ng", "New User Registration Alert", $message, "From: no_reply@propertyhub.com.ng" );					
...
$message="Attention : Smart PropertyHub Limited".
"\n\nPlease be informed that a new agent has succesfully registered on PropertyHub Website.".
"\n\nSee the details below".
...
"\n\nThank you.";
//echo $message;
mail ("info@propertyhub.com.ng", "New Agent Registration Alert", $message, "From: no_reply@propertyhub.com.ng" );							
...
<div class="wrapper_div">
    ...
    <div id="salesRent">REGISTER</div>
     <div id="tabs" style="margin-left: -20px;">
        <ul>
          <li><a href="#tabs-1"><i class="fa fa-user"></i> USER</a></li>
     ...
     <form name="formRegLog" action="" method="post" >
              <input type="text" name="firstName" placeholder="First Name" class="textbox rightMargin30" required pattern="(([A-Za-z_\-\.]){2,})" oninvalid="this.setCustomValidity(this.validity.patternMismatch ? 'Valid name is required' : '');"  />  
              <input type="text" name="lastName" placeholder="Last Name" class="textbox" required pattern="(([A-Za-z_\-\.]){2,})" oninvalid="this.setCustomValidity(this.validity.patternMismatch ? 'Valid name is required' : '');" />   <br />
