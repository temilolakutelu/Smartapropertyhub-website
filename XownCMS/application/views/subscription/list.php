        ...
        <div class="panel-body no-padding">
              ...
              foreach ($subscription_data as $sub) { ?>
                    ...
                    <td class="hidden"></td>
                                        ...
                                        <td><?= $sub->email ?></td>
                                        <td><?= anchor(site_url('subscription/edit/' . $sub->subscriberID), 'Edit', array('class' => 'btn btn-primary btn-sm')) . ' ' . anchor(site_url('subscription/delete/' . $sub->subscriberID), 'Delete', array('class' => 'btn btn-danger btn-sm')) ?>
                          </td>
                    </tr>
             <?php 
          } ?>
