...
<html lang="en" class="coming-soon">
    <head>
        ...
        <meta name="author" content="Temi temilola.kutelu@xown.com.ng">
            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <div class="panel panel-default">
                        ...
                        ?>
                        <form action="<?php echo $action; ?>" class="form-horizontal" id="validate-form" method="POST">
                          ...
                          <div class="panel-footer text-center">
                          <a href="<?= site_url('welcome/forget'); ?>" >Forget Password?</a>
                            </div>
                        </form>
