                                ...
                                <nav role="navigation" class="widget-body">
                                    <ul class="acc-menu">
                                        ...
                                        <?php if ($role_type == 1) { ?>
                                          ...
                                          <li><a href="<?= site_url('subscription'); ?>"><i class="fa fa-address-card"></i> <span> Newsletter Subscription</span></a></li>
                                          <li><a href="<?= site_url('activity'); ?>"><i class="fa fa-line-chart"></i><span> Site Activity</span></a></li>
                                          <li><a href="<?= site_url('facility'); ?>"><i class="fa fa-th"></i><span>Facility</span></a></li>
                                          <li><a href="<?= site_url('news'); ?>"><i class="fa fa-newspaper-o"></i><span>News</span></a></li>
                                          <li><a href="<?= site_url('property'); ?>"><i class="fa fa-building-o"></i></i> <span>Properties</span></a></li>
                    ...
                    <footer role="contentinfo">
                        <div class="clearfix">
                            <ul class="list-unstyled list-inline pull-left">
                                <li><h6 style="margin: 0;">&copy; <?php echo date('Y'); ?> Smart Proprty Hub. By Xown Solutions Ltd</h6></li>
